...
export declare type PageConfigurationParameter = PageConfigurationParameterString | PageConfigurationParameterFilter;
...
export declare const PageSizeTypes: readonly ["sm", "md", "lg"];
export declare type PageSizeType = typeof PageSizeTypes[number];
...
export declare const SplitTypes: readonly ["1/4 3/4", "1/3 2/3", "1/2 1/2", "2/3 1/3", "3/4 1/4", "1/3 1/3 1/3", "1/2 1/4 1/4", "1/4 1/2 1/4", "1/4 1/4 1/2", "1/4 1/4 1/4 1/4"];
export declare type SplitType = typeof SplitTypes[number];
